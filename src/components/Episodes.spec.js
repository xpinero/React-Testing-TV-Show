...
test("renders list of show episodes from API", async () => {
  ...
  const { getByText, getByTestId } = render(<App />);
    ...
    waitFor(() => {
      ...
      expect(getByTestId(/api-name/i)).toHaveTextContent(/Chapter One: Suzie, Do You Copy?/i)
    })
...
//    await waitFor(() => {
//     // const fetchShowButton = getByText(/select/i);
//     // fireEvent.click(fetchShowButton);

//     async () => {
//      // await waitFor( () => {
//         // const fetchSeasonButton = getByText(/season/i);
//         // fireEvent.click(fetchSeasonButton);
//         // await waitFor(() =>
//         //   expect(getAllByTestId(/episodes/i)).toBeInTheDocument()
//         // );
